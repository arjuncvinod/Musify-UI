...
function Home() {
  ...
  return (
    <>
      ...
      <Element className="section" name="about" id="about"></Element>
      <Element className="section" name="contact" id="contact"></Element>
      <Element className="section" name="signup" id="signup"></Element>
    </>
  );
}
